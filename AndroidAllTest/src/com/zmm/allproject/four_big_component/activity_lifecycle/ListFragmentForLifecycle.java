...
public class ListFragmentForLifecycle extends ListFragmentForConsole {
	...
	private static String[] strs = {"title 1","title 2","title 3","title 4","title 5","title 6","title 1","title 2","title 3","title 4","title 5","title 6"};
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		getListView().setAdapter(new ArrayAdapter<String>(getActivity(), android.R.layout.simple_list_item_1, strs));
	}
