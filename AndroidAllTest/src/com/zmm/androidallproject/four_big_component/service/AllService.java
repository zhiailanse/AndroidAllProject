...
import com.zmm.androidallproject.four_big_component.BR.MyBroadcaseRecever;
...
public class AllService extends Service {
	...
	public static String AllServiceAction = "com.zmm.androidallproject.AllService";
...
//		sendOrderedBroadcast(intent, "com.zmm.androidallproject.permission");
		super.onCreate();
